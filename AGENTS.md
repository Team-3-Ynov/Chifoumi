...
> Guide projet pour les agents IA (Codex, Cursor, Codex…). Lis ce fichier **avant toute modification**. Il complète, sans le remplacer, le design figé dans [`docs/superpowers/specs/2026-04-28-rps-ranked-platform-design.md`](docs/superpowers/specs/2026-04-28-rps-ranked-platform-design.md) et le brief [`docs/consignes/projet.md`](docs/consignes/projet.md).
>
